...
const demoNotifications: MadiNotification[] = [
  {
    ...
    body: 'Introligator Demo 1 odklikal pakowanie. Gotowe: 2 szt., czas: 00:07:09.',
    actorName: 'Introligator Demo 1',
    actorInitials: 'MI',
    actorColor: '#2f9e44',
    orderId: '1',
...
export const useNotificationsStore = create<NotificationsState>()(
  persist(
    ...
    {
      name: 'madi-flow-notifications-template-v2-sanitized',
      partialize: (state) => ({

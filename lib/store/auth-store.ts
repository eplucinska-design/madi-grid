...
export const DEMO_USERS: (User & { pin: string })[] = [
  ...
  {
    id: '2',
    email: 'konstruktor.demo',
    name: 'Konstruktor Demo',
    initials: 'KD',
    role: 'designer',
  ...
  {
    id: '6',
    email: 'wlasciciel.demo',
    name: 'Wlasciciel Demo',
    initials: 'WD',
    role: 'owner',
    department: 'CEO',
    avatarColor: '#212529',
...
export const useAuthStore = create<AuthState>()(
  persist(
    ...
    {
      name: 'madi-flow-auth-v2-sanitized',
      partialize: (state) => ({
        user: state.user,

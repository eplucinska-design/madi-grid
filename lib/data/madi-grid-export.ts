...
export const MADI_GRID_GRAFIK_TASKS: MadiGridGrafikTask[] = [
  {
    ...
    assignee: 'EEmilka',
    client: 'WITO LABELS SPOLKA Z OGRANICZONA ODPOWIEDZIALNOSCIA',
  ...
  },
  {
    ...
    priorityLabel: 'Sredni',
    assignee: 'EEmilka',
    client: 'Powiat Poznanski SOSWdDN im. Synow Pulku w Owinskach',
  ...
  },
  {
    ...
    priorityLabel: 'Sredni',
    assignee: 'EEmilka',
    client: 'Projektoria MONIKA LABIJAK',
  ...
  },
  {
    ...
    priorityLabel: 'Sredni',
    assignee: 'EEmilka',
    client: 'COSMO GROUP SPOLKA Z OGRANICZONA ODPOWIEDZIALNOSCIA',
  ...
  },
  {
    ...
    priorityLabel: 'Sredni',
    assignee: 'EEmilka',
    client: 'NOWA ELEKTRO SPOLKA Z OGRANICZONA ODPOWIEDZIALNOSCIA',
  ...
  },
  {
    ...
    priorityLabel: 'Sredni',
    assignee: 'EEmilka',
    client: 'Prowes Wlodzimierz Skopinski',
...
export const MADI_GRID_CUSTOMERS: MadiGridCustomerSeed[] = [
  {
    id: 'mgc-wito-labels',
    companyName: 'WITO LABELS SPOLKA Z OGRANICZONA ODPOWIEDZIALNOSCIA',
    taxId: '',
    address: '',
    city: '',
  ...
  {
    id: 'mgc-cosmo-group',
    companyName: 'COSMO GROUP SPOLKA Z OGRANICZONA ODPOWIEDZIALNOSCIA',
    taxId: '',
    address: '',
    city: '',
    group: 'Z eksportu Madi Grid',
  ...
  {
    id: 'mgc-aqrat',
    companyName: 'AQRAT EWA WRZESINSKA-SKRYPKO',
    taxId: '7642258608',
  ...
  {
    id: 'mgc-an-mar',
    companyName: 'AN-MAR SPOLKA Z OGRANICZONA ODPOWIEDZIALNOSCIA',
    taxId: '7792088639',
